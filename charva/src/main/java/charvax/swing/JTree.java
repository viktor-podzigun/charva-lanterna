...
class JTree {
    ...
    /**
     * Creates an instance of JTree which displays the root node -
    ...
    /**
     * Creates a JTree with the specified TreeNode as its root, which
     ...
     *                           leaf node; if true, only nodes that do not 

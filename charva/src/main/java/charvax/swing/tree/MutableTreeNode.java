...
public interface MutableTreeNode extends TreeNode {
    ...
    /**
     * Removes node from this MutableTreeNode. The setParent() method of "node"
     * will be called.
     */
    public void remove(MutableTreeNode node);

    /**
     * Returns the user object associated with this MutableTreeNode. (this
     * method is not actually in java.swing.tree.MutableTreeNode).
     */

 ...
 * <code>InputMap</code>s are usually used with an <code>ActionMap</code>,
 * to determine an <code>Action</code> to perform when a key is pressed. An
...
public class InputMap {
     ...
     * <code>keys()</code> in that this method includes the keys defined in
     * the parent.
     */

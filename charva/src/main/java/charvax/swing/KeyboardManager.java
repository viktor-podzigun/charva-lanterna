...
class KeyboardManager {
    ...
    public void registerKeyStroke(KeyStroke k, JComponent c) {
        ...
        if (tmp == null) {
            keyMap.put(k, c);
                                            ...
                                            // add to it.
            Vector v = (Vector) tmp;
            if (!v.contains(c)) { // only add if this keystroke isn't
        ...
        if (keyMap != null) { // this container isn't registered, so bail
            ...
            if (tmp == null) {
                ...
                for (int counter = v.size() - 1; counter >= 0; counter--) {
                    ...
                    // "+ v.size());
                    if (c.isShowing() && c.isEnabled()) { // don't want to
                                                            // give these out
                        fireBinding(c, ks, e, pressed);
                        if (e.isConsumed())
                            return true;
                ...
                System.out
                        .println("Unexpected condition in fireKeyboardAction "
                                + tmp);
    ...
    class ComponentKeyStrokePair {
        ...
        public boolean equals(Object o) {
            ...
            return ((component.equals(ckp.component)) && (keyStroke
                    .equals(ckp.keyStroke)));
        }
